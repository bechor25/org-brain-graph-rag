...
| 1 | 07 extract Phase A | 🟡 195/195 batches נוצרו (~8–9k ישויות, ~5.5k יחסים לפי הסוכנים); **merge רץ** | | 2,743 chunks (1,713 KIP sections + 1,030 descriptions) → 195 batches ≤40KB רב-שורתיים, ~24/סוכן, ~187k tokens קלט לסוכן; schema+examples אושרו ע"י המתכנן |
